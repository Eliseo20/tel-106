        ...
        <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            <section className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-sm font-bold text-primary-500 uppercase tracking-[0.3em] whitespace-nowrap">Contenido Técnico</h2>
                    <div className="h-px flex-grow bg-gradient-to-r from-white/10 via-white/10 to-transparent"></div>
                </div>

                <div className="glass-morphism rounded-[2.5rem] p-10 md:p-14 space-y-16 list-none border border-white/5">
                    {/* Title and Abstract */}
